...
.car-banner-01 {
    background-image: url(~/assets/img/banners/banner-01.jpg);
}

.car-banner-02 {
    background-image: url(~/assets/img/banners/banner-02.jpg);
}

.car-banner-03 {
    background-image: url(~/assets/img/banners/banner-03.jpg);
}
