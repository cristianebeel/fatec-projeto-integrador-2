<template>
    <div class="my-6">
        ...
        <template v-else>
            ...
            <div class="flex flex-col mx-auto mt-6 w-2/5 p-4 space-y-4
...
export default {
    ...
    async fetch(){
        try{
            this.waiting = true
            this.messages = await this.$axios.$get('https://fatec-herois-resistencia.herokuapp.com/chat')
            ...
            if(!this.username){
                ...
                if(this.newMessage){
                    try{
                        ...
                        await this.$axios.$post('https://fatec-herois-resistencia.herokuapp.com/chat', msg)
                        this.newMessage = ''
                    }
                    catch{
