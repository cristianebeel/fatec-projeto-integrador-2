        ...
        <div class="container mx-auto px-6 py-3">
            <div class="flex items-center justify-between">
                <div class="hidden w-full text-gray-600 md:flex md:items-center">
                    ...
                    <span class="mx-1 text-sm">BR</span>
                </div>
            ...
            <nav :class="isOpen ? '' : 'hidden'" class="sm:flex sm:justify-center sm:items-center mt-4">
                <div class="flex flex-col sm:flex-row">
                    <a class=" font-bold mt-3 text-red-600 hover:underline sm:mx-3 sm:mt-0" href="#">RomaHome</a>
                    <a class="font-bold mt-3 text-red-600 hover:underline sm:mx-3 sm:mt-0" href="#">Escolar</a>
                    <a class="font-bold mt-3 text-red-600 hover:underline sm:mx-3 sm:mt-0" href="#">Produtos</a>
                    <a class="font-bold mt-3 text-red-600 hover:underline sm:mx-3 sm:mt-0" href="#">Contato</a>
                    <a class="font-bold mt-3 text-red-600 hover:underline sm:mx-3 sm:mt-0" href="#">Sobre Nós</a>
                </div>
            </nav>
